...
export const productAPI = createApi({
    ...
    endpoints: (builder) => ({
        ...
        categories: builder.query<CategoriesResponse, string>({query: ()=> `category`, providesTags:[ "product"]}),
        ...
        ProdectDetails: builder.query<ProductResponse, string>({query: (id)=> id, providesTags:[ "product"]}),
